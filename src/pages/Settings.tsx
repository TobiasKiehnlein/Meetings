...
import { IonAlert, IonButton, IonContent, IonHeader, IonInput, IonItem, IonLabel, IonPage, IonTitle, IonToast, IonToolbar } from '@ionic/react';
...
const Settings: React.FC = () => {
	...
	const exportJson = async () => {
		if (meetings) {
			...
			setToast('Please add some meetings first!');
		}
	};
		...
		<IonPage>
			...
			<IonContent>
				<IonItem>
					...
					<IonButton slot="end" className="ion-margin" onClick={ () => json !== '' ? setImportAlert(true) : setToast('Please add JSON into the input field!') }>
						Import JSON
					</IonButton>
				</IonItem>
				<IonItem>
